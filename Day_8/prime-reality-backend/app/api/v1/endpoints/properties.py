...
def create_property(
    ...
    try:
        ...
        # Trigger email alerts if property status becomes approved (currently pending, but future-proof)
        if new_property.status == "approved":
            try:
                ...
                # Log error but do not fail property creation
...
def update_property(
    ...
    try:
        ...
        # If status changed to approved, trigger alerts
