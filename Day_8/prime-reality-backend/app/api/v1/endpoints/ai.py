...
# Setup basic logging for tracking internal errors
...
# -------------------- 2. Price Prediction --------------------
@router.get("/predict-price/{property_id}", response_model=PricePredictionResponse)
@limiter.limit("100/minute")
def predict_price(
    request: Request,
    property_id: int,
...
# -------------------- 3. Recommendations --------------------
@router.get("/recommendations/{property_id}", response_model=RecommendationResponse)
@limiter.limit("100/minute")
...
# -------------------- 7. Virtual Tour --------------------
@router.post("/virtual-tour", response_model=VirtualTourResponse)
@limiter.limit("100/minute")
def virtual_tour(
    request: Request,
