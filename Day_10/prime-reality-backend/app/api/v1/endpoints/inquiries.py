# This file contains API endpoints related to inquiries in the real estate platform.
# It allows buyers to create inquiries for properties, view their inquiries,
# and allows sellers to manage inquiries for their properties. Admins can also update inquiry statuses.
# The endpoints are protected with authentication and role-based access control
# to ensure only authorized users can perform certain actions.
...
def create_inquiry(
    ...
    try:
        ...
        # Explicitly convert SQLAlchemy model to Pydantic schema
...
def get_my_inquiries(
    ...
    try:
        ...
        # Convert each SQLAlchemy inquiry to Pydantic schema
        return [InquiryResponse.model_validate(inq) for inq in inquiries]
