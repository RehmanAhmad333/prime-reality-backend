...
# this file defines the Property model which represents a real estate property in the database. It includes various attributes such as title, description, price, location, and more. The model also establishes a relationship with the User model to link properties to their sellers.
