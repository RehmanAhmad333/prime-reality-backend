...
class Settings:
    ...
    ACCESS_TOKEN_EXPIRE_MINUTES = 6000 # User ka main token sirf 30 minutes ke liye valid rahega. 30 mins baad yeh expiry ki wajah se bekaar ho jayega. Iska faida yeh hai ke agar koi aapka token chura bhi le, to wo 30 mins baad khud hi expire ho jayega.
